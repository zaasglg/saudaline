                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(functions.formatStatusProvider(getJsonField(widget.order, r'''$.status''',).toString()), 'error',),
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text("${functions.doubleToInt(getJsonField(widget.order, r'''$.totalAmountWithDiscount''',)).toString()} Тг", style: const TextStyle(
                                      color: Colors.black,
                                      fontFamily: "Futura",
                                      fontSize: 20,
                                      fontWeight: FontWeight.w600,
