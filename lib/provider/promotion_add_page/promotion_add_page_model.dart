...
import 'promotion_add_page_widget.dart' show PromotionAddPageWidget;
...
class PromotionAddPageModel extends FlutterFlowModel<PromotionAddPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (Create Promotion)] action in Button widget.
  ApiCallResponse? apiResultoCreatePromotion;
