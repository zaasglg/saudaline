...
class TariffsWidget extends StatefulWidget {
  const TariffsWidget({
    super.key,
    int? myTariffId,
  }) : this.myTariffId = myTariffId ?? 0;

  final int myTariffId;

  @override
  State<TariffsWidget> createState() => _TariffsWidgetState();
}
                              ...
                              return Builder(
                                builder: (context) {
                                  final tariff = getJsonField(
                                    listViewGetAllTariffsResponse.jsonBody,
                                    r'''$''',
                                  ).toList();
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, tariffIndex) {
                                      final tariffItem = tariff[tariffIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 10.0, 20.0, 0.0),
                                        child: Container(
